...
<?= $this->section('content') ?>
  ...
  <!-- Welcome Banner -->
  <div class="card border-0 shadow-lg mb-5" style="background: linear-gradient(90deg, #0d6efd, #6f42c1); border-radius: 1rem;">
    ...
    <div class="col-md-4">
      <div class="card menu-card text-center shadow-sm border-0 h-100">
        <div class="card-body py-5">
          ...
          <a href="<?= site_url('admin/anggota') ?>" class="btn btn-gradient rounded-pill mt-2 px-4">Kelola</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card menu-card text-center shadow-sm border-0 h-100">
        <div class="card-body py-5">
          ...
          <a href="<?= site_url('admin/komponen') ?>" class="btn btn-gradient rounded-pill mt-2 px-4">Kelola</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card menu-card text-center shadow-sm border-0 h-100">
        <div class="card-body py-5">
          ...
          <a href="<?= site_url('admin/penggajian') ?>" class="btn btn-gradient rounded-pill mt-2 px-4">Kelola</a>
        </div>
      </div>
    </div>
  </div>
